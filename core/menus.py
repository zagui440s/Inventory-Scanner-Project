from core.inventory import (
    ...
    manage_out_reasons, review_flagged_scans,
    review_offline_queue, view_transfers
)
...
def superadmin_menu(session):
    while True:
        ...
        print("  5.  Manage out reasons")
        print("  6.  View session audit log")
        print("  7.  Review flagged scans")
        print("  8.  Review offline queue")
        print("  9.  View transfer audit")
        print("  10. Start scanning session")
        print("  11. Generate donor snapshot")
        print("  12. Logout")
